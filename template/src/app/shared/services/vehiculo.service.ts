...
function sort(tableItem: Vehiculos[], column: SortColumn, direction: string): Vehiculos[] {
    if (direction === '' || column === '') {
        return tableItem;
    } else {
...
function matches(table: Vehiculos, term: string, pipe: PipeTransform) {
    return table.mode_Nombre.toLowerCase().includes(term.toLowerCase());
  }
...
export class TableService {
  ...
  VehiculoListado = Global + "Vehiculos/Listado";
