...
function sort(tableItem: MetodosDePago[], column: SortColumn, direction: string): MetodosDePago[] {
    if (direction === '' || column === '') {
        return tableItem;
    } else {
...
function matches(table: MetodosDePago, term: string, pipe: PipeTransform) {
    return table.meto_Descripcion.toLowerCase().includes(term.toLowerCase());
  }
...
export class TableService {
    ...
    private _search(): Observable<SearchResult> {
      ...
      MetodosDePagoListado = Global + "MetodosPago/Listado";
