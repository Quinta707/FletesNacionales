  ...
  onLoggedin(e: MouseEvent) {
    ...
    this.http.post(apiUrl, requestBody).subscribe(
      (response: any) => {
        ...
        if (response && response.user_NombreUsuario) {
          localStorage.setItem('user', JSON.stringify(response));
          localStorage.setItem('IdUsuario', response.user_Id);
          localStorage.setItem('Usuario', response.user_NombreUsuario);
          localStorage.setItem('empe_Id', response.empe_Id);
          localStorage.setItem('user_EsAdmin', response.user_EsAdmin);
          localStorage.setItem('empe_NombreCompleto', response.empe_NombreCompleto);
