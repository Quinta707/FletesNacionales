...
>>>>>>> Ian
    ...
    iconElement.classList.add('fa-forward'); 
    iconElement.classList.add('mx-2'); 
    iconElement.setAttribute('ngbPopover', 'You see, I show up on hover!');
    iconElement.setAttribute('triggers', 'mouseenter:mouseleave');
    iconElement.setAttribute('popoverTitle', 'Pop title');
