...
@NgModule({
  ...
  imports: [CommonModule, WidgetsRoutingModule, NgbModule, CountToModule, CarouselModule, ChartistModule, NgChartsModule, FormsModule, SharedModule, NgApexchartsModule, DashboardModule],
})
